...
\def\secretary{mmorel008}
\def\others{alfloch001, mabeauvais}
...
\input{sections/section-1}\label{sec1}

\input{sections/section-2}\label{sec2}

\input{sections/section-3}\label{sec3}
